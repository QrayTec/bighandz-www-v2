<template>
  <div class="relative w-full flex justify-center">
    ...
    <div
      class="absolute bottom-[50px] right-0 h-[60px] w-[60px] lg:bottom-[120px] lg:right-[5%] lg:h-[120px] lg:w-[120px]"
    >
      <img src="@/assets/images/index_main/25th.png" />
    </div>
    <div
      v-if="MAIN_CONTENT_WIDTH === 1200"
      class="flex flex-col animate-[moveContainer_3s_infinite_alternate] lg:absolute lg:bottom-[120px] lg:left-[5%]"
    >
      <div
