  ...
  >
    ...
    <div class="text-deep_blue mt-[30px] text-[1rem] leading-[2rem] font-[400]">
      <p>
        ...
        ｖTradExはグローバル的に各業種に向け3,000社以上の導入実績がある総合的な物流パッケージです。ビッグハンズ社はvTradExに日本販売代理店となっております。日本の顧客様が安心でvTradExを利用できるため、ビッグハンズ社は日本でのｖTradExを販売するとともに現地でのパッケージ導入・カスタマイズなどの技術サポートもしております。
      </p>
    </div>
