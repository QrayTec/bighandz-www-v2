<template>
  ...
  >
    <div class="relative h-[125px] w-full overflow-hidden">
      ...
      >
        <div
          class="font-NotoSansJP bg-GartnerCard h-full w-[125px] flex flex-col items-center justify-center px-[22.5px] text-center text-[18px] font-[700]"
        >
...
const props = defineProps<{ carddata: GartnerCardType }>()

const CardData = ref<GartnerCardType>(
  props.carddata || {
    BackgroundImage: '',
    className: '',
    title_1: '',
